...
- Paid-plan pricing must not treat Stripe as the forward-looking source of truth. `<stripe-pricing-table>` is a legacy interim path. Forward-looking landing work should assume Lago-backed plan data and platform-owned CTA/orchestration.
