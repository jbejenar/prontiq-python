...
- Paid-plan pricing must not treat Stripe as the forward-looking source of truth. Landing billing surfaces are first-party and Lago-backed; Stripe is only the payment rail behind Lago.
