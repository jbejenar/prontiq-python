...
class LookupResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> LookupResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/prontiq/prontiq-platform#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> LookupResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/prontiq/prontiq-platform#with_streaming_response
        """
