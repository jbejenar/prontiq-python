...
class Prontiq(SyncAPIClient):
    ...
    def __init__(
        ...
        *,
        ...
        custom_headers_env = os.environ.get("PRONTIQ_CUSTOM_HEADERS")
    ...
    def with_raw_response(self) -> ProntiqWithRawResponse:
        return ProntiqWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> ProntiqWithStreamedResponse:
        return ProntiqWithStreamedResponse(self)
...
class AsyncProntiq(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def with_raw_response(self) -> AsyncProntiqWithRawResponse:
        return AsyncProntiqWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncProntiqWithStreamedResponse:
        return AsyncProntiqWithStreamedResponse(self)
...
class ProntiqWithRawResponse:
    _client: Prontiq

    def __init__(self, client: Prontiq) -> None:
        self._client = client
...
class AsyncProntiqWithRawResponse:
    _client: AsyncProntiq

    def __init__(self, client: AsyncProntiq) -> None:
        self._client = client
